...
В шестом проекте была реализована валидация силами JS. Добавил закрытие Popup по нажатию на клавишу Escape и кликом на overlay.
...
* Grid-Layout
* popup
* реализована валидация для форм, с помощью JavaScrip
### Обзор
